...
public class IllegalArgumentExceptionHandlerTest {
    ...
    public void setup() {
        this.mvc = MockMvcBuilders
                ...
                .setControllerAdvice(new IllegalArgumentExceptionHandler(localeUtilsMessage))
                .build();
    }
    ...
    public void testHandleIllegalArgumentException() throws Exception {
        this.mvc.perform(get("/tests/exception/illegal-argument"))
                ...
                .andExpect(result -> {
                    ...
                    assertThat(errorResponse.getError()
                                            .getInternal()
                                            .getException()).isEqualTo("Illegal argument exception message");
                })
                .andDo(print());
