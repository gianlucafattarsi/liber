...
public class IllegalStateExceptionHandlerTest {
    ...
    public void setup() {
        this.mvc = MockMvcBuilders
                ...
                .setControllerAdvice(new IllegalStateExceptionHandler(localeUtilsMessage))
                .build();
    }

    @Test
    @DisplayName("Test IllegalStateException")
    public void testHandleIllegalStateException() throws Exception {
        this.mvc.perform(get("/tests/exception/illegal-state"))
                ...
                .andExpect(result -> {
                    ...
                    assertThat(errorResponse.getError()
                            ...
                            result.getRequest()));
                    assertThat(errorResponse.getError()
                                            .getUserMessage()).isEqualTo(result.getResolvedException()
                                                                               .getMessage());
                    assertThat(errorResponse.getError()
                                            .getInternal()
                                            .getException()).isEqualTo("Illegal state exception message");
                })
                .andDo(print());
